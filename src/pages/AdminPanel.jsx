  ...
  return (
    <div className={"py-5 "}>
      <div className='flex items-center gap-3 p-3 justify-end rounded-xl transition-all duration-200'>
        <img src={`${hero}`} className='w-10 h-10 rounded-full' alt="" /> <Badge variant='default' className={"bg-green-500 rounded-r-full rounded-l-full"}>admin</Badge>
        <span className='text-blue-500 hover:text-blue-700'><Link to="/"> go to site</Link></span>
      </div>
