...
export default function Footer() {
  ...
  return (
    <footer className="w-full border-t bg-background" style={theme === "light" ? { backgroundColor: "#fff", color: "#000" } : { backgroundColor: "#333", color: "#fff" }}>
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-2">
              Build modern web apps using React and shadcn/ui components.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li className="hover:text-foreground cursor-pointer">Products</li>
